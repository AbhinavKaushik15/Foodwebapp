  ...
  return (
    <div className="relative w-full h-[115.6vh]">
      <div>
        ...
        <div className="absolute top-[45.9vh] w-full h-[53vh] px-5 flex items-center gap-8">
          {/* logo */}
          <div className="w-[67vh] h-full flex flex-col gap-5">
            <Image
          ...
          {/* Quick Link 1 */}
          <div className="w-[40vh] h-full text-white flex flex-col gap-6">
            <h1 className="font-['Fredoka'] font-[900] text-xl mb-2">
              Quick Links 1
            </h1>
            <Link
          ...
          {/* Download */}
          <div className="w-[50vh] h-full font-['Fredoka'] text-white flex flex-col gap-6">
            <h1 className="font-['Fredoka'] font-[900] text-xl mb-2">
              Download Our App
            </h1>
            <Image
