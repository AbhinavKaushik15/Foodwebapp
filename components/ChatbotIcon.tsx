  ...
  return (
    ...
    >
      <div className="group relative bg-black border-4 border-[#DB6885] w-16 h-16 rounded-full flex items-center justify-center">
        ...
        <span className="absolute -top-16 left-[50%] w-24 -translate-x-[50%] z-20 origin-left scale-0 px-3 rounded-lg border border-gray-300 bg-white py-2 text-sm font-bold shadow-md transition-all duration-300 ease-in-out group-hover:scale-100">
          Fofood AI Chatbot<span> </span>
        </span>
      </div>
    </Link>
  );
